"""Optional Ollama-based PII extraction (not used by the MCP server)."""
...
from utils.scrubber import (
    PIIData,
    PIIScrubber,
    _mask_known_values,
    _nonempty_pii_values,
    scrub_deterministic,
)
...
def extract_pii_with_ollama(
    ...
    *,
    ...
    scrubbed = scrub_deterministic(scrubbed, mask=mask)
